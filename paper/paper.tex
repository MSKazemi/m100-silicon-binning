...
\item \textbf{[OI-6, OI-7] Two small anomalies remain unexplained}: 48 socket-days reporting a core
outside the socket's modal set, and two nodes whose transitions span only a one-day gap.
